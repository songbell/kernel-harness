"""Generated by `ckh kernelgen` from "C:\\Users\\openvino-258v002\\AppData\\Local\\Temp\\pytest-of-openvino-258v002\\pytest-34\\test_kernel_prepare_falls_back0\\ovdump\\bar_123456789__sa.cl".
...
(no host .cpp matched)::Bar123456789SaGenerator, which is C++ that branches on
...
SOURCE = "opencl/tests/bar_123456789__sa.cl"
ENTRY = "bar"
...
SPEC = KernelSpec(
    name="bar_123456789__sa",
    source=SOURCE,
    prod_source="bar_123456789__sa.cl",
    entry=ENTRY,
    jit=jit,
    dispatch=dispatch,
    args=args,

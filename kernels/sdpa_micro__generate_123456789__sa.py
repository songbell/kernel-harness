"""Generated by `ckh kernelgen` from "C:\\Users\\openvino-258v002\\AppData\\Local\\Temp\\pytest-of-openvino-258v002\\pytest-34\\test_kernel_prepare_prefers_du0\\ovdump\\sdpa_micro__generate_123456789__sa.cl".
...
(no host .cpp matched)::SdpaMicroGenerate123456789SaGenerator, which is C++ that branches on
...
SOURCE = "opencl/tests/sdpa_micro__generate_123456789__sa.cl"
ENTRY = "sdpa_micro__generate"
...
SPEC = KernelSpec(
    name="sdpa_micro__generate_123456789__sa",
    source=SOURCE,
    prod_source="sdpa_micro__generate_123456789__sa.cl",
    entry=ENTRY,
    jit=jit,
    dispatch=dispatch,
    args=args,

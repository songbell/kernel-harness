"""Generated by `ckh kernelgen` from "C:\\Users\\openvino-258v002\\AppData\\Local\\Temp\\pytest-of-openvino-258v002\\pytest-34\\test_kernel_prepare_ports_and_0\\prod\\src\\plugins\\intel_gpu\\src\\graph\\impls\\cm\\foo.cm".
...
(no host .cpp matched)::FooGenerator, which is C++ that branches on
